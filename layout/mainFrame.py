...
class bmiMainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = _(u"BMI Rechner AI-DLC"), pos = wx.DefaultPosition, size = wx.Size( 770,460 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )

        self.SetSizeHints( wx.Size( 770,460 ), wx.DefaultSize )

        content_box = wx.BoxSizer( wx.VERTICAL )

        self.m_staticText8 = wx.StaticText( self, wx.ID_ANY, _(u"BMI AI Rechner"), wx.DefaultPosition, wx.DefaultSize, 0 )
        ...
        self.m_staticText8.SetMinSize( wx.Size( 280,55 ) )
